...
public class DriveSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Right Distance", Math.round(getRightEncoderDistanceCM()));
        SmartDashboard.putNumber("Left Distance", Math.round(getLeftEncoderDistanceCM()));
